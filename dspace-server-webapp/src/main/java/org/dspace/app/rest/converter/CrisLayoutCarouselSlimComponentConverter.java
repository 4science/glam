...
import org.dspace.layout.CrisLayoutCarouselSlimComponent;
 ...
 */
@Component
public class CrisLayoutCarouselSlimComponentConverter implements CrisLayoutSectionComponentConverter {

    @Override
    public boolean support(CrisLayoutSectionComponent component) {
        return component instanceof CrisLayoutCarouselSlimComponent;
    }

    @Override
    public CrisLayoutSectionComponentRest convert(CrisLayoutSectionComponent component) {
        return new CrisLayoutSectionRest.CrisLayoutCarouselSlimComponentRest(
            (CrisLayoutCarouselSlimComponent)component);
    }
