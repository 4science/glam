...
DECLARE
    old_metadata_fields text[] := ARRAY [
        'glam.misn', 'glam.misp', 'glam.misd', 'glam.miss', 'glam.misg', 'glam.misc', 'glam.misw', 'glam.misb', 'glam.misi'
        ];
    new_metadata_fields text[] := ARRAY [
        'dc.format.misn', 'dc.format.misp', 'dc.format.misd', 'dc.format.miss', 'dc.format.misg', 'dc.format.misc', 'dc.format.misw', 'dc.format.misb', 'dc.format.misi'
        ];
